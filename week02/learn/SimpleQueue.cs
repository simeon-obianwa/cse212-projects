public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: Enqueue added to front instead of back; Dequeue accessed index 1 instead of 0.
        ...
        // Defect(s) Found: None, logic already corrected
    }
    ...
    {
        // FIX: Added to the back of the list instead of inserting at index 0
        _queue.Add(value);
    }
    ...
    private int Dequeue()
    {
        ...
        // FIX: Retrieve and remove from the front of the queue at index 0 
        var value = _queue[0];
        _queue.RemoveAt(0);
        return value;
    }
